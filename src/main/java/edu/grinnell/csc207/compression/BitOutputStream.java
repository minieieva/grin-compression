...
public class BitOutputStream {
     ...
     * @param debug
     *            true iff you want to output the bits as ASCII 0s and 1s
     ...
     *
     * @param bits
     *            the bits to write as an integer
     * @param n
     *            the number of bits to write from the integer
     */
    ...
    /**
     * Flushes the buffer. If numDigits < BYTE_SIZE, flush will pad the output with
     * extra 0s in the least-significant bits so that a full byte is written to the
     * file.
     */
    private void flush() {
