...
public class HuffmanTree {
     ...
     *
     * @param freqs
     *            a map from 9-bit values to frequencies.
     */
    public HuffmanTree(Map<Short, Integer> freqs) {
        ...
        PriorityQueue<Node> queue = new PriorityQueue<>(
                Comparator.comparingInt(leafOrInternalNode -> leafOrInternalNode.size));
     ...
     *
     * @param in
     *            the input file (as a BitInputStream)
    ...
    /**
     * Writes this HuffmanTree to the given file as a stream of bits in a serialized
     * format.
     *
     * @param current
     *            the current node in a tree
     * @param out
     *            the output file as a BitOutputStream
     */
     ...
     *            the current node in a tree
     * @param codes
     *            a map from byte values to their codes
     * @param code
     *            the current code
     */
     ...
     * this Huffman tree. The encoded values are written, bit-by-bit to the given
     * BitOuputStream.
     *
     * @param in
     *            the file to compress.
     * @param out
     *            the file to write the compressed output to.
     */
    ...
    /**
     * Decodes a stream of huffman codes from a file given as a stream of bits into
     * their uncompressed form, saving the results to the given output stream. Note
     * that the EOF character is not written to out because it is not a valid 8-bit
     * chunk (it is 9 bits).
     *
     * @param in
     *            the file to decompress.
     * @param out
     *            the file to write the decompressed output to.
     */
